...
* **Genesis**: "Go through this document, find test scenarios, then draft a plan we'll review, then start implementation. Should be a maven project with all kinds of features of SDET with 5+ yoe..."
* **Feedback Modulation**: "Use PageFactory @FindBy... Include assertions for Login success, Product added to cart, Cart matching selected item, Order confirmation... Make it sound how an automation expert would write, like a 150+ IQ person."
...
These prompts are designed to maintain the "SDET 5+ YoE" standard as the framework scales:
